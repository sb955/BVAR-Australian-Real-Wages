...
posterior_t <- function(Y, X, p, S){
  ...
  list(A.posterior.draws = A.posterior.draws, Sigma.posterior.draws = Sigma.posterior.draws)

}


#posterior_t(Y.bv, X.bv, 1, 100)
#wage_data_post_t <- posterior_t(Y, X, 4, 100)
```
...
```{r}
mcxs5_shade <- rgb(220/255, 128/255, 128/255, alpha = 0.2)
par(mfrow = c(5, 2), mar = c(2, 2, 1, 1), oma = c(0, 0, 2, 0))
